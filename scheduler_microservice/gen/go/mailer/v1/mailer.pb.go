...
const file_mailer_v1_mailer_proto_rawDesc = "" +
	...
	"\rMailerService\x12I\n" +
	"\n" +
	"SendEmails\x12\x17.mailer.v1.EmailRequest\x1a\x1e.mailer.v1.EmailStatusResponse(\x010\x01B2Z0scheduler_microservice/gen/go/mailer/v1;mailerv1b\x06proto3"
